...
class AdminEditBoatDetails extends StatefulWidget {

  @override
  State<AdminEditBoatDetails> createState() => _AdminEditBoatDetailsState();
}

class _AdminEditBoatDetailsState extends State<AdminEditBoatDetails> {
